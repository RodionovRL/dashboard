 ...
 * This service sends messages with user json data to the "payment-user-get-response" Kafka topic.
 */
@Service
@AllArgsConstructor
public class PaymentUserGetProducer {
    /**
     * Logger for the {@link PaymentUserGetProducer} class.
     */
    private static final Logger log = LoggerFactory.getLogger(PaymentUserGetProducer.class);
    ...
    public void sendMessage(UserDto userDto) {
        ...
        kafkaTemplate.send("payment-user-get-response", userJson);
        log.debug("Sent response to Kafka with user data. Topic: payment-user-get-response , user: {}", userJson);
    }
}
