...
@Service
@AllArgsConstructor
public class GetPaymentProducer {

    /**
     * Logger for the {@link GetPaymentProducer} class.
     */
    private static final Logger log = LoggerFactory.getLogger(GetPaymentProducer.class);
    ...
    public void sendMessage(PaymentDto paymentDto) {
        ...
        kafkaTemplate.send("payment-get-response", paymentJson);
